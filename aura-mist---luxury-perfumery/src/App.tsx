        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px]">
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 right-8 flex items-end justify-between">
              <div>
                <h3 className="text-3xl font-serif text-white mb-2">FOR HIM</h3>
                <p className="text-white/60 text-sm">Bold, woody, and sophisticated</p>
              </div>
          ...
          >
            <img 
              src="https://images.unsplash.com/photo-1485872299829-c673f5194813?auto=format&fit=crop&q=80&w=800" 
              alt="For Her"
              className="absolute inset-0 w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700"
              referrerPolicy="no-referrer"
            />
            ...
            <div className="absolute bottom-8 left-8 right-8 flex items-end justify-between">
              <div>
                <h3 className="text-3xl font-serif text-white mb-2">FOR HER</h3>
                <p className="text-white/60 text-sm">Elegant, floral, and radiant</p>
              </div>
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center -rotate-45 group-hover:rotate-0 transition-transform">
                <ArrowRight className="w-6 h-6 text-hazy-blue-950" />
              </div>
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 right-8 flex items-end justify-between">
              <div>
                <h3 className="text-3xl font-serif text-white mb-2">UNISEX</h3>
                <p className="text-white/60 text-sm">Balanced, unique, and versatile</p>
              </div>
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center -rotate-45 group-hover:rotate-0 transition-transform">
                <ArrowRight className="w-6 h-6 text-hazy-blue-950" />
              </div>
